...
testUpdate = [
    ...
    , test "test transpose 1" $ assertEq (Data.Matrix.transpose (fromVects [[1,2,3]])) $ fromVects [[1],[2], [3]]
    , test "test transpose 2" $ assertEq (Data.Matrix.transpose (fromVects [[1,2,3], [4,5,6]])) $ fromVects [[1,4],[2,5], [3,6]]
